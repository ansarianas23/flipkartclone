...
function Cart() {
  ...
  return (
    <div className='w-[65vw] h-auto mx-auto mt-5 flex justify-between relative bg-red-300'>
      ...
      {carts?.length === 0 && <div className="bg-white w-full h-full absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] flex flex-col items-center">
