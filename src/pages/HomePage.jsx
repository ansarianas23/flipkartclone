  ...
  return (
    <>
      ...
      <div className="h-auto flex flex-col items-center mt-2 rounded-sm mx-2">
        ...
        {/* Category slider bar */}
        <div className="w-full h-fit mb-2 md:mb-4 bg-white flex justify-center">
          <CategoriesBar />
        </div>

        {/* Banner Image Slider */}
        <div className="w-full h-auto mb-2 md:mb-4 ">
          <BannerImageSlider />
        </div>

        {/* Product Slider 1*/}
        <div className="w-full h-fit mb-2 md:mb-4 bg-white z-10" >
        ...
        <div className="grid grid-cols-12 gap-4 w-full h-fit mb-2 md:mb-4 z-10" >
